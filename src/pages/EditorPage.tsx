    ...
    <div className="relative w-full h-screen bg-neutral-950 overflow-hidden font-poppins text-white select-none">
      ...
      <FloatingSidebar side="left">
        ...
        <div className="relative">
          ...
          {showEditMenu && (
            <div className="absolute left-10 -top-1 bg-[#15151a]/80 backdrop-blur-xl border border-white/10 rounded-full flex items-center px-1 py-1 gap-1 z-[75] shadow-2xl animate-in slide-in-from-left-2 fade-in duration-200">
              <SidebarButton 
