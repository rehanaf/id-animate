...
export function App() {
           ...
           {proj.thumbnail ? (
             ...
             <>
               ...
               <div className="absolute inset-0 flex items-center justify-center">
                  {proj.type === "figure" ? <Shapes className="w-10 h-10 text-green-500 opacity-20 group-hover:opacity-40 group-hover:scale-110 transition-all duration-500" /> : <Video className="w-10 h-10 text-blue-500 opacity-20 group-hover:opacity-40 group-hover:scale-110 transition-all duration-500" />}
               </div>
             </>
           )}
         </div>
  ...
  return (
    ...
    >
      ...
      <button 
        className="fixed bottom-8 right-8 w-16 h-16 text-white rounded-full flex items-center justify-center shadow-xl transition-all hover:scale-105 active:scale-95 z-[100] bg-green-600 hover:bg-green-500 shadow-green-600/40"
        ...
        >
          <div className="mx-auto w-full flex-1 overflow-hidden flex flex-col min-h-0">
            <DrawerHeader className="shrink-0">
              <DrawerTitle>New Animation (Figure)</DrawerTitle>
            </DrawerHeader>
            ...
            <DrawerFooter className="p-5 pt-2 shrink-0">
              <Button 
                className="w-full h-10 text-sm font-bold rounded-full text-white transition-all bg-green-600 hover:bg-green-500"
